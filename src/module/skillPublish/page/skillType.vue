<template>
  <div>
    <top title="<span class='middle'>同城</span><em class='title_circle mlr10'>●</em><span class='middle'>技能发布</span>" rightIcon="icon-fangdajing" @clickRight="handleClickRight"></top>
    <div class="nav_menus">
      <ul class="nav_list">
    ...
    <div class="skill_type_list">
      <div class="skill_type_box">
        ...
        <ul class="skill_list">
          <li class="skill_item" v-for="el in secondList" @click="toDemandPublish(el)">
...
<script>
import {
  fetchGetGoodsTypeList, //一级
  fetchGetGoodsTypeListTwo //二级
...
export default {
  ...
  watch: {
    fid: function() {
      ...
      fetchGetGoodsTypeListTwo(this.fid).then(res => {
  ...
  activated() {
    //默认读取第一级类目
    fetchGetGoodsTypeList().then(res => {
