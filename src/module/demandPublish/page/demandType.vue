<template>
  <div>
    <top title="<span class='middle'>同城</span><em class='title_circle mlr10'>●</em><span class='middle'>发布需求</span>" @clickRight="handleClickRight"></top>
    <div class="nav_menus">
      <ul class="nav_list">
    ...
    <div class="skill_type_list">
      <div class="skill_type_box">
        ...
        <ul class="skill_list">
          <li class="skill_item" v-for="el in secondList" @click="routerDemandPublish(el)">
...
export default {
  ...
  methods: {
    ...
    routerDemandPublish(el) {
      this.$router.push(
        '/demandPublish?skillCategory=' +
          this.fid +
          '&skillSubCategory=' +
          el.skillId
      )
