<template>
	<div class="oil_invite">
		...
		<!-- E 选项卡 -->
		<div class="pb20">
			<a href="javascript:void(0);" @click="goStation" class="station_btn">立即下载APP</a>
		</div>
		<div class="oil_invite_banner bg_gray">
			<img src="../images/warm_prompt.png" />
		</div>
	</div>
</template>
<script>
...
import imgShow from '../components/imgShow'; //安卓视频组件
import imgShowIos from '../components/imgShowIos'; //苹果视频组件
